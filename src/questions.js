...
[[
	...
	new Question("À quoi correspond cette image ?",
		...
		question.difficulte.BUG,
		question.categorie.ENVIRONNEMENT,
		"Avant, on testait ces aspects de l'aéronautique dans des souffleries en reproduisant le phénomène physique réel, souvent à plus petite échelle. Maintenant, l'ingeniérie numérique permet de faire toutes sortes de tests uniquement avec des simulations, des expériences numériques. C'est un changement majeur.",
		question.SANS_IMAGE_EXPLICATION,
		     "https://interstices.info/maillage",
		new Reponse(reponse.type.CM,
	...
	new Question("Que représente cette image?",
		...
		question.SANS_IMAGE_EXPLICATION,
		"https://interstices.info/jcms/c_36343/image-04-avril-2008", 
		new Reponse(reponse.type.CM,
  	...
  	new Question("Comment peut-on sauver des vies avec des équations mathématiques ?",
		...
		question.SANS_IMAGE_EXPLICATION,
		     "https://interstices.info/modele-seisme",
    		new Reponse(reponse.type.CM,
  	...
  	new Question("Si trois chiffres peuvent valoir soit 0, soit 1, combien y a-t-il de combinaisons possibles ?",
		...
		question.difficulte.BUG,
		question.categorie.FONDAMENTAUX,
		     "On peut avoir les 8 combinaisons: 000, 001, 010, 011, 100, 101, 110, 111. C'est ainsi que l'on compte en binaire de 0 à 7 (qui s'écrit donc 111)",
		question.SANS_IMAGE_EXPLICATION,
		question.SANS_SOURCE, 
    		new Reponse(reponse.type.CM,
			[8, 9, 3],
	...
	new Question("À quand remonte le plus vieux document crypté connu ?",
		...
		question.SANS_COMMENTAIRE,
		question.SANS_IMAGE_EXPLICATION,
		"http://fr.wikipedia.org/wiki/Histoire_de_la_cryptologie#Le_plus_vieux_document_chiffr.C3.A9",
    		new Reponse(reponse.type.CM,
	...
	new Question(["Qu’est-ce qui depuis 2008 pollue le plus entre les avions et les ordinateurs ?", "Comment peut-on intelligemment diminuer la consommation des ordinateurs ?"],
		...
		question.SANS_IMAGE_EXPLICATION,
		"https://interstices.info/idee-recue-informatique-14", 
	...
	new Question("Laquelle de ces images correspond à une modélisation ?",
		...
		question.SANS_IMAGE_EXPLICATION,
		"https://interstices.info/hepatique", 
    		new Reponse(reponse.type.CM,
			[1, 2, 3],
			3)),
	...
	new Question("Que représente cette image ?",
		...
		"./flamands.jpg",
		"https://interstices.info/jcms/c_40093/image-20-septembre-2008", 
    		new Reponse(reponse.type.CM,
	...
	new Question("Que voit-on sur cette image ?",
		...
		question.SANS_IMAGE_EXPLICATION,
		     "https://interstices.info/ressources-forestieres",
    		new Reponse(reponse.type.CM,
	...
	new Question("Que représente cette scène ?",
		...
		question.SANS_IMAGE_EXPLICATION,
		"https://interstices.info/realite-virtuelle-experience",
    		new Reponse(reponse.type.CM,
	...
	new Question("Qu’est-ce que c’est ?",
		...
		question.SANS_IMAGE_EXPLICATION,
		"https://interstices.info/neuronavigation",
    		new Reponse(reponse.type.CM,
...
[
	...
	new Question("Parmi ces propositions, que ne peuvent PAS faire aujourd’hui les chirurgiens grâce aux sciences du numérique ?",
		...
		question.difficulte.DEFAILLANCE,
		question.categorie.SANTE,
		"De l’acquisition au simulateur de chirurgie, l’image médicale subit de nombreux traitements informatiques. L’intérêt : disposer d’une « copie virtuelle » du patient, qui pourra être utilisée du diagnostic jusqu’à la chirurgie assistée par ordinateur.<br/>La visualisation en temps réel de l'intérieur du patient est à l'étude, mais pas encore opérationnelle.", "https://interstices.info/jcms/i_58396/le-patient-virtuel-au-service-de-la-chirurgie", 
		new Reponse(reponse.type.CM,
			["Voir l’intérieur du patient en train d’être opéré, sans inciser","S’entraîner au geste chirurgical","Créer un avatar numérique du patient pour s'adapter spécifiquement à son anatomie"],
			1)),
	...
	new Question("Quelle n'est PAS la raison pour laquelle les scientifiques doivent rendre publics leurs données et les logiciels de leurs travaux ?",
		question.SANS_IMAGE,
		question.type.DIRECTE,
		question.difficulte.DEFAILLANCE,
		question.categorie.SOCIETE,
	...
	new Question("Que représente cette image ?",
		...
		"./INRIA-CDR0053-0081.jpg",
		"https://interstices.info/simulation-cataracte",
		new Reponse(reponse.type.CM, 
	...
	new Question("Que représente cette image?",
		...
		"./anevrisme.jpg",
		     "https://interstices.info/ecoulements",
		new Reponse(reponse.type.CM, 
	...
	new Question("Que représente cette image ?",
		...
		question.SANS_IMAGE_EXPLICATION,
		     "http://www.docsciences.fr/Au-coeur-du-foie",
		new Reponse(reponse.type.CM, 
...
[
	...
	new Question("Que représente cette image ?",
		...
		question.SANS_IMAGE_EXPLICATION,
		     "https://interstices.info/a-propos-maillages",
		new Reponse(reponse.type.CM, 
