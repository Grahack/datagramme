...
[
	...
	/*@todo new Question("Voici un code A=1, B=2, C=3, etc., Z=26. Écrire le mot SCIENCE à l’aide de ce code",
		question.SANS_IMAGE,
	...
	/* @todo new Question("Parmi ces deux définitions, laquelle se rapporte à modélisation et laquelle se rapporte à simulation ?",
		question.SANS_IMAGE,
		question.type.DIRECTE, 
		question.difficulte.DEFAILLANCE, 
		question.categorie.FONDAMENTAUX, 	
	...
	/* @todo new Question("Parmi ces deux définitions, laquelle se rapporte à statistiques et laquelle se rapporte à probabilités ? ",
		question.SANS_IMAGE,
		question.type.DIRECTE, 
		question.difficulte.DEFAILLANCE, 
		question.categorie.FONDAMENTAUX, 	
...
[
	...
	/* @todo new Question("Combien de pas me faut-il pour atteindre un mur si je franchis à chaque pas la moitié de la distance qui me sépare du mur en question",
		question.SANS_IMAGE,
		question.type.CASSE_TETE, 
		question.difficulte.PANNE_SYSTEME, 
		question.categorie.FONDAMENTAUX, 	
...
// Question comme à choix multiple ? Ok si la réponse contient «infini».lowerCase() ?
*/
	...
	/* @todo new Question("Quand je joue à pile ou face, lequel de ces deux événements est aléatoire et lequel est prédictible  ?",
		question.SANS_IMAGE,
		question.type.DIRECTE, 
		question.difficulte.PANNE_SYSTEME, 
		question.categorie.FONDAMENTAUX, 	
       ...
       "Le nombre de piles et de faces qui vont sortir sur 100 000 lancés."], 
			"1/ Aléatoire\n2/ Prédictible")),
// comment traiter cette question. Ce n'est pas un choix multiple, il faudrait reformuler la question et/ou les réponses.
*/
	...
	/* @todo new Question("Ce programme bogue, il n’arrive jamais au bout, pourquoi ? \n\n problèmes = 100\nbonheur = 0\nTANT QUE (problèmes > 0  ) ALORS  { problèmes = problèmes + 1 }\nLORSQUE FIN DE BOUCLE  bonheur = 1 ; Fin du programme.",
		...
		new Reponse(reponse.type.CM, 
	       ...
	       // Une réponse à trou ? «La variable \"problèmes\" ne cesse d'???. Or, pour que le programme se termine, il faut qu'elle descende à ???»
*/


	/*@todo new Question("Si on suit cet algorithme, que choisit Paul comme plat ? Paul = joyeux\nÉmilie = soucieuse\nSI ( Émilie = soucieuse ET Paul = soucieux ) ALORS  { commande[Paul] = tartare ; commande[Émilie] = sushis }\nDANS LES CAS CONTRAIRES { commande[Paul] = sushis ; commande[Émilie] = tartare }",
		question.SANS_IMAGE,
		question.type.CASSE_TETE, 
		question.difficulte.PANNE_SYSTEME, 
		question.categorie.FONDAMENTAUX, 	
...
// Oui avec case intensivite et pluriel accepté donc n importe quele chaine qui contienne "sushi"
